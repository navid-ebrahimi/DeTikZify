# # -*- coding: utf-8 -*-
# """final-generating-images (14).ipynb

# Automatically generated by Colab.

# Original file is located at
#     https://colab.research.google.com/drive/1R7asCmdvRRLgpdU4n_jHjVxCfXq7NRJ_
# """
...
# # !perl ./install-tl-20241111/install-tl --no-interaction
...
#              '-shell-escape',  # Enable shell escape
        ...
        except fitz.fitz.UnsupportedError:
            print(f"Unsupported error: Unable to render {output_figure_name} due to annotations.")
            return False
...
def save_metadata_to_parquet_limited(metadata, output_dir, base_filename="tikz_sample", max_file_size=500 * 1024 * 1024):
    """
    ...
    Args:
        ...
        max_file_size (int): Maximum file size in bytes (default 500 MB).
    """
